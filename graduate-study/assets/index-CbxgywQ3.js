    ...
    <main>
      ...
      <section class="support-grid">
        <section class="notice-card" aria-labelledby="pending-title">
          <p class="section-kicker">还差一步确认</p>
          <h2 id="pending-title">安全课的具体分班</h2>
          <p>${e.pending[0].detail}</p>
          <span class="notice-tag">当前未写入日历订阅源</span>
        </section>
      ...
      <footer>
        <span>课程数据源：培养计划、学院课表、2026 秋季校历</span>
